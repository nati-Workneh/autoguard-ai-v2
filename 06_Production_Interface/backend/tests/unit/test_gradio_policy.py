"""Regression coverage for the Gradio interface's shared business-policy integration."""
...
GRADIO_PATH = REPO_ROOT / "05_Gradio_Interface" / "gradio_app.py"


def _load_risk_classifier_without_constructing_the_ui():
    """Execute only the pure risk-band function from the Gradio source."""
