...
MODELS_DIR = PROJECT_ROOT / "03_Model"
...
class AutoGuardPredictor:
    ...
    def _build_top_risk_drivers(
        ...
        add_numeric_driver(
            ...
            increase_detail="Longer policy tenure aligns with higher-risk portfolio patterns in similar cases.",
            decrease_detail="Shorter policy tenure aligns with lower-risk portfolio patterns in similar cases.",
        )
        add_numeric_driver(
            "age_of_policyholder",
        ...
        add_numeric_driver(
            ...
            higher_increases_risk=True,
            increase_detail="Higher-density operating areas were linked to higher claim exposure in similar cases.",
            decrease_detail="Lower-density operating areas were linked to lower claim exposure in similar cases.",
        )
        add_numeric_driver(
            "area_cluster__freq",
            "Area cluster exposure",
            higher_increases_risk=True,
            increase_detail="This area cluster belongs to a higher-exposure segment of the portfolio.",
            decrease_detail="This area cluster belongs to a lower-exposure segment of the portfolio.",
        )
        add_numeric_driver(
            "safety_feature_count",
            "Safety feature coverage",
            higher_increases_risk=False,
            increase_detail="A lighter safety-feature package raises review concern in this assessment.",
            decrease_detail="A stronger safety-feature package helps offset review concern in this assessment.",
        )
        add_numeric_driver(
        ...
        add_numeric_driver(
            ...
            "Crash safety rating",
            higher_increases_risk=False,
            increase_detail="Lower crash-safety ratings align with higher claim risk in similar cases.",
        ...
        add_numeric_driver(
            ...
            "Airbag count",
            higher_increases_risk=False,
            increase_detail="Lower airbag coverage aligns with higher claim exposure in similar cases.",
            decrease_detail="Higher airbag coverage aligns with lower claim exposure in similar cases.",
        )
        ...
        add_binary_driver(
            ...
            "Drum rear brakes",
            "increase",
            "Drum rear brakes aligned with higher review concern in similar cases.",
        )
        add_binary_driver(
            "rear_brakes_type__Disc",
            "Disc rear brakes",
            "decrease",
            "Disc rear brakes aligned with lower review concern in similar cases.",
        )
        ...
        if not candidates:
            generic_drivers = [
                RiskDriver(
                    ...
                    direction="increase",
                    detail="Policy tenure is one of the strongest global drivers in similar cases.",
                ),
                RiskDriver(
                    title="Area exposure profile",
                    direction="increase",
                    detail="Area exposure remains one of the strongest global signals in similar cases.",
                ),
                RiskDriver(
